...
public class Reconstructions {
    ...
    private List<ReconstructionsStatus> reconstructionsList;

    public List<ReconstructionsStatus> getReconstructionsList() {
        return reconstructionsList;
    }

    public void setReconstructionsList(List<ReconstructionsStatus> reconstructionsList) {
