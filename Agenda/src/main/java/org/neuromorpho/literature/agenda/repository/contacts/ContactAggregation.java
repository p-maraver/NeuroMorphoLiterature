...
public class ContactAggregation {
    ...
    private List<Contact> paginatedResults;
    private List<Count> count;

    public ContactAggregation() {
    }

    public List<Contact> getPaginatedResults() {
        return paginatedResults;
    }

    public void setPaginatedResults(List<Contact> paginatedResults) {
