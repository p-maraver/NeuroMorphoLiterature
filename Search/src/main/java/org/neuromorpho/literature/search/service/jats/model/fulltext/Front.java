...
public class Front {
    ...
    public List<String> getAffiliationList() {
        return this.articleMetadata.getAffiliationList();
    }


    public String getAbstract() {
        return this.articleMetadata.getAbstract();
    }

    public List<ContributorGroup> getContributorGroup() {
        return this.articleMetadata.getContribGroupList();
    }

    public String getTitle() {
        return this.articleMetadata.getTitle();
    }
}
